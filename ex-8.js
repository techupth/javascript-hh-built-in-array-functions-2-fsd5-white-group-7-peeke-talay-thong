...
// Start coding here
function SumOfBillLocation(bill) {
  let locationName = bill.reduce((totalLocation, currentMember) => {
    totalLocation[currentMember.location] = (totalLocation[currentMember.location] || 0) + currentMember.total;
    return totalLocation;
  }, {});
  return locationName;
}

const totalPaidByLocation = SumOfBillLocation(bills);
